...
window=Tk()
#window config
window.title('Show all properties| Developed by Era ')
window.state('zoomed')
...
update_prop_button = Button(window,text="Update Property",relief=GROOVE, bg="#49111c", fg="#FFFFFF", borderwidth=3,font=("times new roman", 14,),command= update_prop)
update_prop_button.place(x=580,y=600)
